...
local blip1 = AddBlipForCoord(1683.45, 2604.83, 45.56) 
SetBlipSprite(blip1, 189)  ----// Find blips sprite from  https://docs.fivem.net/docs/game-references/blips/
SetBlipScale(blip1, 0.8) 
SetBlipColour(blip1, 1) ---// Colours also can find there
